...
Firstly the dataset were downloaded and unzipped to the working directory in the R file. Secondly R code was downloadedto the source in the R working directory. Finally, execute R source code to generate tidy data file.
